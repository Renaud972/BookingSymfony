...
class User implements UserInterface
{
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\Length(min=10,minMessage="Votre titre de présentation doit comporter au moins 10 caractères")
     */
    private $introduction;

    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=100,minMessage="Votre présentation doit comporter au moins 100 caractères")
     */
    private $description;
    ...
    public function initializeSlug(){
        if(empty($this->slug)){
            ...
            $slugify = new Slugify();
            $this->alias = $slugify->slugify($this->firstname.' '.$this->lastname);
