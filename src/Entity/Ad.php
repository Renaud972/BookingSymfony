...
class Ad
{
     ...
     * @Assert\Length(min=10,max=255,minMessage="Le titre doit avoir plus de 10 caractères",maxMessage="Votre titre ne doit pas dépasser 255 caractères")
     */
    private $title;
    ...
    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=300,minMessage="Merci de mettre au moins 30 caractères")
     */
    private $content;
